...
I created a [little script](https://gist.github.com/zaidmukaddam/c2a3234dfc2c91b2f699b9ed6bb5b424) to measure their respective memory usage with manually triggered full garbage collection in each measurement. Run it with `node --expose-gc` and I got the following results:
